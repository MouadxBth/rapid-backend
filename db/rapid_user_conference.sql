...
CREATE TABLE `user_conference` (
  ...
  CONSTRAINT `user_conference_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  CONSTRAINT `user_conference_ibfk_2` FOREIGN KEY (`conference_id`) REFERENCES `conferences` (`id`)
